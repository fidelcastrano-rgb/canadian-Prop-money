      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-12 text-center sm:text-left">
          ...
          <p className="text-gray-400 max-w-lg text-sm leading-relaxed font-light">
             Query D1 databases in real-time to track local active cinematic print batches, Certificate of Authenticity (COA) compliance clearances, and courier parcels.
          </p>
        </div>
                ...
                {order.history && order.history.length > 0 ? (
                  order.history.map((step, idx) => (
                    <div key={idx} className="relative">
                      ...
                      <div className="text-[11px] font-mono text-gray-505 text-gray-400 mt-1">
  ...
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-background text-white flex flex-col items-center justify-center p-4">
        ...
        <p className="text-gray-400 font-light uppercase tracking-widest text-xs">Connecting D1 Tracking Panel...</p>
      </div>
    }>
      <TrackOrderContent />
    </Suspense>
