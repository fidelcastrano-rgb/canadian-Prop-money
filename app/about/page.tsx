...
export default function AboutPage() {
  const breadcrumbLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: 'About Us',
        item: 'https://canadianpropmoney.org/about'
      }
    ]
  };
  ...
  const organizationLd = {
    ...
    description: 'Premier supplier of highly realistic, legally compliant replica currency stacks for the North American motion pictures and television industry.',
    ...
    <>
      ...
      <div className="bg-background min-h-screen">
         ...
         <section className="bg-black text-white py-24 md:py-32 relative overflow-hidden">
           <Image 
             src="/hero1.png" 
             alt="High-Fidelity Prop Money Production Background" 
             fill 
             priority 
