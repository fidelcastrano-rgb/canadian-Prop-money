               ...
               {relatedProducts.map(rp => (
                  <Link key={rp.id} href={`/products/${rp.id}`} className="block group">
                    <div className="relative aspect-[4/3] overflow-hidden mb-4 bg-black/40 border border-white/10">
                      <Image src={resolveImageUrl(rp.image || "/hero1.png")} alt={rp.name} fill className="object-cover group-hover:scale-105 transition duration-500" referrerPolicy="no-referrer" />
                    </div>
